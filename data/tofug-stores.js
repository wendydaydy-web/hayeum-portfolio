...
const rawStores = [
  ...
  // ★★ 2·3·4호점: 실제 TofuG 매장 정보 대기 중 (사용자 제공 예정) ★★
  {
    no: 2, name: '싱가폴 2호점', city: '', country: 'Singapore',
    openDate: '2025', status: 'open', byMe: true, address: '',
    descKo: '실제 매장명·주소·설명으로 교체해 주세요.',
    descEn: 'Replace with the real store name, address and description.',
    video: '', mainImage: '', gallery: '', placeId: '', url: '',
  },
  {
    no: 3, name: '싱가폴 3호점', city: '', country: 'Singapore',
    openDate: '2025', status: 'open', byMe: true, address: '',
    descKo: '실제 매장명·주소·설명으로 교체해 주세요.',
    descEn: 'Replace with the real store name, address and description.',
    video: '', mainImage: '', gallery: '', placeId: '', url: '',
  ...
  {
    no: 4, name: '싱가폴 4호점', city: '', country: 'Singapore',
    openDate: '2025', status: 'open', byMe: true, address: '',
    descKo: '실제 매장명·주소·설명으로 교체해 주세요.',
    descEn: 'Replace with the real store name, address and description.',
