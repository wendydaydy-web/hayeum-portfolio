  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .flavor-text-ko { color: #c8111a; font-family: 'Playfair Display', 'Noto Serif KR', serif; font-size: clamp(20px, 1.7vw, 30px); font-weight: 400; line-height: 1.55; letter-spacing: -0.005em; }
        .flavor-text-en {
          color: #c8111a;
